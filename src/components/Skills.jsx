...
const Skills = () => {
  const skillsData = [
    ...
    {
      category: 'Apprenticeship Tech Stack',
      skills: ['Python', 'XGBoost', 'Pandas', 'SQL', 'Streamlit'],
    },
    {
      category: 'IDE & Tools',
      skills: ['Visual Studio', 'Notepad++', 'Jupyter'],
    },
    {
      category: 'Operating System & Version Control',
      skills: ['Windows Family', 'Git'],
    },
  ];
      ...
      <div className="relative z-10 max-w-6xl mx-auto px-6 md:px-8">
        ...
        >
          ...
          <p className="text-sm text-black/60 font-normal">
            Core skills and tools focused on scripting, web technologies, and data analytics.
          </p>
        </motion.div>
